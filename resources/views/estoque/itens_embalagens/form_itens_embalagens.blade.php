...
<div style="padding: 0 20px 20px 20px; background-color: #ffffff; min-height: 100vh; font-family: Arial, sans-serif;">
    ...
    <h2>{{ $isEdit ? '✏️ Editar Grupo' : '👥 Novo Grupo' }}</h2>

    <div class="card">
        @if ($formAction === '#')
            <div class="alert">
                Rotas de salvar/atualizar grupo ainda nao foram criadas. Configure as rotas para concluir o envio do formulario.
            </div>
        @endif
        ...
        <form action="{{ $formAction }}" method="POST">
            ...
            <div class="card-header">
                <strong style="font-size: 18px; color: #2c3e50;">
                    {{ old('str_nome', $grupo->str_nome ?? 'Novo Grupo') }}
                </strong>
            </div>
            ...
            <div class="field-group full">
                <div class="field">
                    ...
                    <input type="text" name="str_nome" maxlength="150" required
            ...
            <div class="field-group">
                <div class="field">
                    ...
                    <select name="is_active">
                        ...
                        <option value="0" {{ old('is_active', $grupo->is_active ?? 1) == 0 ? 'selected' : '' }}>Nao</option>
                    </select>
                </div>
            </div>
            ...
            <div class="actions">
                ...
                <button class="btn btn-primary" type="submit">
                    {{ $isEdit ? 'Salvar Alteracoes' : 'Cadastrar Grupo' }}
                </button>
            </div>
        </form>
    </div>
