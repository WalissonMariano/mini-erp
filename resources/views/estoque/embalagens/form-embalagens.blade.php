...
<div class="app-shell">
    <div class="app-page">
        <header class="app-header">
            ...
            @if ($isEdit)
                <button type="button" class="app-btn app-btn--secondary" onclick="loadContent('{{ route('pagina.lista.embalagens') }}')">
                ...
                <div class="app-form-toolbar">
                    ...
                    @if ($isEdit)
                        <button
                            ...
                            formaction="{{ route('pagina.deletar.embalagens', ['id' => $embalagem->id]) }}"
                            name="_method"
                            value="DELETE"
                            onclick="return confirm('Excluir esta embalagem permanentemente?')">
                            Excluir embalagem
                        </button>
                    @endif
