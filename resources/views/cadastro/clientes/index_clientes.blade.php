<div style="padding: 0 20px 20px 20px; background-color: #ffffff; min-height: 100vh; font-family: Arial, sans-serif;">
    ...
    <div class="header-bar">
        <div>
            <h2 style="margin: 0 0 4px 0;">👥 Cadastro de Clientes</h2>
            <div class="subtitle">Grade com todos os clientes cadastrados</div>
        </div>
        <button onclick="loadContent('{{ route('pagina.novo.cliente') }}')" class="new-btn" type="button" title="Novo cliente">
            + Novo Cliente
        </button>
    </div>
        ...
        <table>
            ...
            <tbody>
                @forelse ($clientes as $cliente)
                    ...
                    <tr>
                        <td>
                            <button onclick="loadContent('{{ route('pagina.editar.cliente', ['id' => $cliente->id]) }}')" class="edit-btn" type="button" title="Editar cliente">
                                ✏️
                            </button>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="8" style="text-align: center; color: #7f8c8d;">Nenhum cliente cadastrado.</td>
                    </tr>
                @endforelse
